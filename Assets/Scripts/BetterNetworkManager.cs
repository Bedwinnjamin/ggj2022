...
/// </summary>
public class BetterNetworkManager : NetworkRoomManager
{
    ...
    public override GameObject OnRoomServerCreateRoomPlayer(NetworkConnection conn)
    {
        ...
        var player = gameObject.GetComponent<RoomPlayer>();
        player.playerIsRed = clientIndex > 1;
        print($"adding player {clientIndex}");
